                                            ...
                                            <tr>
                                                <td class="col-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <p class="font-bold ms-3 mb-0">Brian Osoro</p>
                                                    </div>
                                                </td>
                                                <td class="col-auto">
                                                    <p class=" mb-0">Happy to be part of the Symatech Team</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="col-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <p class="font-bold ms-3 mb-0">Caroline Kibet</p>
                                                    </div>
                                                </td>
                                                <td class="col-auto">
                                                    <p class=" mb-0">The Best Parasitoligist In Kenya</p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <div class="card">
                    ...
                    <div class="card-content pb-4">
                        <div class="recent-message d-flex px-4 py-3">
                            ...
                            <div class="name ms-4">
                                <h5 class="mb-1">Rashid JUMA</h5>
                                <h6 class="text-muted mb-0">@juma</h6>
                            </div>
                        </div>
                        <div class="recent-message d-flex px-4 py-3">
                            <div class="avatar avatar-lg">
                            ...
                            <div class="name ms-4">
                                <h5 class="mb-1">Brian Osoro</h5>
                                <h6 class="text-muted mb-0">@Osoro</h6>
                            </div>
                        </div>
                        <div class="recent-message d-flex px-4 py-3">
                            <div class="avatar avatar-lg">
                            ...
                            <div class="name ms-4">
                                <h5 class="mb-1">Kenyatta</h5>
                                <h6 class="text-muted mb-0">@kenya</h6>
                            </div>
                        </div>
                        <div class="px-4">
    ...
    <footer>
        <div class="footer clearfix mb-0 text-muted">
            <div class="float-start">
                <p>2022 &copy; Symatech Limited</p>
            </div>
            <div class="float-end">
                <p>Crafted with <span class="text-danger"><i class="bi bi-heart"></i></span> by <a
                href="#">Symatech Limited</a></p>
            </div>
        </div>
    </footer>
</div>
